    ...
    implements MouseListener, ActionListener
{
    ...
    public MinWin()
    {
        ...
        l8 = new JLabel("Layered Approach Using Conditional Random Fields for Intrusion Detection");
...
//*****************************************************************
     ...
     jpNewUser.setLayout(null);
        ...
        jLabel7.setText("Layered Approach Using Conditional Random Fields for Intrusion Detection");
