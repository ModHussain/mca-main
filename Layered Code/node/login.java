...
public class login 
{
	public static void main(String aa[])
	{
	   ...
	   {	
		...
		log1.setTitle("Layered Approach Using Conditional Random Fields for Intrusion Detection");	
		String host1="";
...
//		getContentPane().setLayout(null);
		...
		agenttext3=new JLabel("Layered Approach Using Conditional Random Fields for Intrusion Detection");
...
//////////
		...
		agenttext1=new JLabel("Layered Approach Using Conditional Random Fields for Intrusion Detection");
